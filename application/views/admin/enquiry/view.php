                            ...
                            <div class="divTable" style="display:none;">
                            	...
                            	<div class="TableRow">
                                    ...
                                    <div class="table_col">
                                        ...
                                        <? if(!empty($enquiry_data->updated_on)){echo date("d-m-Y h:i:s A" , strtotime($enquiry_data->updated_on));}else{echo "-";}?>
                                    </div>
                                </div>                           
                            	<div class="TableRow">
                                	<div class="table_col">
                                        <label class="label_content_br">Updated By<span class="colen">:</span></label>
                                        <? if(!empty($enquiry_data->updated_by_name)){echo $enquiry_data->updated_by_name;}else{echo "-";}?>
                                    </div>
                                	<div class="table_col">
...
<td >
									...
									<tr>
                                        ...
                                        <td colspan="3"><strong class="full">Subject</strong><?=$enquiry_data->subject?></td>
                                    ...
                                    <tr>
                                        ...
                                        <strong class="full">Tour Name</strong>
                                         <?=$enquiry_data->tour[0]->name?></td>
                                         <td colspan="2">
                                        <strong class="full">Tour Date</strong>
                                        <?= $enquiry_data->tour_date[0]->start_date_time ?> TO <?= $enquiry_data->tour_date[0]->end_date ?></td>
                                    </tr>
