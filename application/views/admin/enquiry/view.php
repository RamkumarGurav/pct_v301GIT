                ...
                <div class="card ">
                    ...
                    <div class="card-header">
                        ...
                        <div class="float-right">
							...
							?>
							<a href="<?php  echo MAINSITE_Admin.$user_access->class_name?>/edit/<?php  echo $enquiry_data->enquiry_id?>"> 
                    ...
                    <div class="card-body card-primary card-outline">
                            ...
                            <div class="divTable" style="display:none;">
                            	...
                            	<div class="TableRow">
                                    ...
                                    <div class="table_col">
                                        ...
                                        <?php  if(!empty($enquiry_data->updated_on)){echo date("d-m-Y h:i:s A" , strtotime($enquiry_data->updated_on));}else{echo "-";}?>
                                    </div>
                                </div>                           
                            	<div class="TableRow">
                                	<div class="table_col">
                                        <label class="label_content_br">Updated By<span class="colen">:</span></label>
                                        <?php  if(!empty($enquiry_data->updated_by_name)){echo $enquiry_data->updated_by_name;}else{echo "-";}?>
                                    </div>
                                	<div class="table_col">
                                        <label class="label_content_br">Status<span class="colen">:</span></label>
                                        <?php  if($enquiry_data->status==1){ ?> Active <i class="fas fa-check btn-success btn-sm "></i>
                            ...
                            <table id="" class="table table-bordered table-hover myviewtable responsiveTableNewDesign"  >
								...
								<tr>
										...
										<?php  echo $enquiry_data->enquiry_id?></td>
										<td >
...
<?php  echo $enquiry_data->name?></td>
<td >
                                        <strong  class="full">Email</strong>
                                        <?php  echo $enquiry_data->email?></td>
									...
									<tr>
                                        ...
                                        <td><strong class="full">Contact No</strong><?php  echo $enquiry_data->contactno?></td>
                                        <td colspan="3"><strong class="full">Subject</strong><?php  echo $enquiry_data->subject?></td>
                                    ...
                                    <tr>
                                        ...
                                        <strong class="full">Enquiry Descriptrion</strong>
                                         <?php  echo $enquiry_data->description?></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                        <strong class="full">Tour Name</strong>
                                         <?php  echo $enquiry_data->tour[0]->name?></td>
                                         <td colspan="2">
                                        <strong class="full">Tour Date</strong>
                                        <?php  echo  $enquiry_data->tour_date[0]->start_date_time ?> TO <?php  echo  $enquiry_data->tour_date[0]->end_date ?></td>
                                    </tr>
                                    ...
                                    <td >
                                        ...
                                        <?php  if(!empty($enquiry_data->updated_by_name)){echo $enquiry_data->updated_by_name;}else{echo "-";}?></td>
                                    <td >
										<strong class="full">Updated On</strong>
										<?php  if(!empty($enquiry_data->updated_on)){echo date("d-m-Y h:i:s A" , strtotime($enquiry_data->updated_on));}else{echo "-";}?></td>
									<td >
