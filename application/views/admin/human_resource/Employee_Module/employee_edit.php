            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item"><a href="<?php  echo MAINSITE_Admin.$user_access->class_name."/employee-view/".$admin_user_id?>">View</a></li>
						<?php  } ?>
        ...
        <div class="row">
                            ...
                            <input type="hidden" name="approval_access" value="0">
								...
								<div class="col-lg-3 col-md-4 col-sm-6">
									...
									<div class="">
										...
										<tbody>
										<?php  $c_count=0;foreach($company_profile_data as $cpd){$c_count++; ?>
											<tr>
											...
											?>
											<select type="text" class="form-control form-control-sm" id="user_role_id" name="user_role_id[]" >
												<option value="">Select Role</option>
												<?php  foreach($users_role_data as $urd){
													$selected="";
													if($urd->user_role_id == $selected_role){$selected = "selected";}
													?>
													<option value="<?php  echo $urd->user_role_id?>" <?php  echo $selected?>><?php  echo $urd->user_role_name?>
													<?php  if($urd->status!=1){echo " [Block]";} ?>
													</option>
												<?php  } ?>
											</select>
											</td>
									...
									<?php  }else{ ?>
										...
										<input type="hidden" name="company_profile_id[]" value="<?php  echo $cpd->company_profile_id?>">
											...
											?>
											<select required type="text" class="form-control form-control-sm" id="user_role_id" name="user_role_id[]" >
								...
								<div class="col-lg-3 col-md-4 col-sm-6">
									<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Designation <span style="color:#f00;font-size: 22px;margin-top: 3px;">*</span></label>
									<div class="col-sm-12">
									<select type="text" class="form-control form-control-sm" required id="designation_id" name="designation_id" >
										<option value="">Select Designation</option>
										<?php  foreach($designation_data as $d){
											$selected="";
											if($d->designation_id == $designation_id){$selected = "selected";}
											?>
											<option value="<?php  echo $d->designation_id?>" <?php  echo $selected?>><?php  echo $d->designation_name?>
											<?php  if($d->status!=1){echo " [Block]";} ?>
											</option>
										<?php  } ?>
									</select>
								...
								<div class="col-lg-3 col-md-4 col-sm-6">
									<label for="inputEmail3" class="py-0 px-2 col-sm-12 col-form-label-lg label_content">Joining Date  <span style="color:#f00;font-size: 22px;margin-top: 3px;">*</span></label>
                                        <div class="col-sm-12">
                                        <div class="input-group date joining_date_input" id="joining_date_input" data-target-input="nearest">
                                            <input type="text" readonly="readonly" value="<?php  echo $joining_date_input?>" name="joining_date" id="joining_date" placeholder="Joining Date" style="width: 100%;"  class="form-control datetimepicker-input width100 form-control-sm" data-target="#joining_date_input"/>
								...
								<div class="col-lg-3 col-md-4 col-sm-6">
									<label for="inputEmail3" class="py-0 px-2 col-sm-12 col-form-label-lg label_content">Termination Date  <span style="color:#f00;font-size: 22px;margin-top: 3px;">*</span></label>
                                        <div class="col-sm-12">
                                        <div class="input-group date termination_date_input" id="termination_date_input" data-target-input="nearest">
                                            <input type="text" readonly="readonly" value="<?php  echo $termination_date_input?>" name="termination_date" id="termination_date" placeholder="Termination Date" style="width: 100%;"  class="form-control datetimepicker-input width100 form-control-sm" data-target="#termination_date_input"/>
                                ...
                                <div class="form-group row">
									...
									<div class="col-sm-12">
									<input type="text" class="form-control form-control-sm" required id="first_name" name="first_name" value="<?php  echo $first_name?>" placeholder="First Name">
									</div>
								</div>
								...
								<div class="col-lg-3 col-md-4 col-sm-6">
									...
									<div class="col-sm-12">
									<input type="text" class="form-control form-control-sm"  id="last_name" name="last_name" value="<?php  echo $last_name?>" placeholder="Last Name">
								...
								<div class="col-lg-3 col-md-4 col-sm-6">
									<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Password <span style="color:#f00;font-size: 22px;margin-top: 3px;">*</span></label>
									<div class="col-sm-12">
									<input type="text" class="form-control form-control-sm" required id="show_password" name="show_password" value="<?php  echo $show_password?>" placeholder="Password">
									</div>
								</div>
								...
								<div class="col-lg-3 col-md-4 col-sm-6">
									<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Fax No. <span style="color:#f00;font-size: 22px;margin-top: 3px;"></span></label>
									<div class="col-sm-12">
									<input type="number" class="form-control form-control-sm" pattern="[0-9]{8,15}" id="fax_no" name="fax_no" value="<?php  echo $fax_no?>" placeholder="Fax No.">
									</div>
								</div>
								...
								<div class="col-lg-3 col-md-4 col-sm-6">
									<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Address 2 <span style="color:#f00;font-size: 22px;margin-top: 3px;"></span></label>
									<div class="col-sm-12">
                ...
                <table class="table table-sm">
                    ...
                    <tbody class="collapse" id="uploadImg">
                        ...
                        <tr id="quotation_enquiry_file_<?php  echo $f->admin_user_file_id?>">
                            <td><a href="<?php  echo _uploaded_files_?>employee_file/<?php  echo $f->file_name?>" target="_blank"><?php  echo $f->file_title?></a></td>
                            <td><button class="btn btn-outline-danger btn-xs" onclick="return delEmployeeFile('<?php  echo $f->admin_user_file_id?>')" title="remove"><i class="fas fa-trash"></i></button></td>
                        </tr>
                        <?php  } ?>
			...
			<?php  } ?>
								...
								<div class="col-lg-2 col-md-4 col-sm-6">
									<label for="data_view1" class="col-sm-12 label_content px-2 py-0">Data View <span style="color:#f00;font-size: 22px;margin-top: 3px;"></span></label>
									<div class="col-sm-12">
									<div class="form-check" style="margin-top:12px">
										<div class="form-group clearfix">
											<div class="icheck-success d-inline">
												<input type="radio" name="data_view" <?php  if($data_view==1){echo "checked"; }?> value="1" id="data_view1">
												<label for="data_view1"> Yes
												</label>
											</div>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<div class="icheck-danger d-inline">
												<input type="radio" name="data_view" <?php  if($data_view!=1){echo "checked"; }?> value="0" id="data_view2">
								...
								<div class="col-lg-2 col-md-4 col-sm-6">
									<label for="radioSuccess1" class="col-sm-12 label_content px-2 py-0">Status <span style="color:#f00;font-size: 22px;margin-top: 3px;">	</span></label>
									<div class="col-sm-12">
									<div class="form-check" style="margin-top:12px">
										<div class="form-group clearfix">
											<div class="icheck-success d-inline">
