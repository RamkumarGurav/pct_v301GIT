...
<tr class="qe_sub_table_tr_tdate">
  ...
  <td>
    <div>
      <label>
        <input type="radio" name="is_discount_tdate[<?php echo $id_tdate - 1 ?>]"
          id="is_discount_tdate_yes_<?php echo $id_tdate ?>" value="1" checked
          onchange="toggleDiscountFields(<?php echo $id_tdate - 1 ?>)"> Yes
      </label>
      <label>
        <input type="radio" name="is_discount_tdate[<?php echo $id_tdate - 1 ?>]"
          id="is_discount_tdate_no_<?php echo $id_tdate ?>" value="0"
          onchange="toggleDiscountFields(<?php echo $id_tdate ?>)"> No
      </label>
    </div>
  </td>
  <td>
    <div class="d-flex" id="actual_price_fields_<?php echo $id_tdate ?>">
      <input type="number" min="1" name="actual_price_tdate[]" id="actual_price_tdate_<?php echo $id_tdate ?>"
        placeholder="Actual Price" class="form-control search-code form-control-sm" />
    </div>
  </td>
  <td>
    <div class="d-flex" id="discounted_price_fields_<?php echo $id_tdate ?>">
      <input type="number" min="1" name="discounted_price_tdate[]" id="discounted_price_tdate_<?php echo $id_tdate ?>"
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    toggleDiscountFields(<?php echo $id_tdate ?>);
  });
