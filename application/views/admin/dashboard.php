          ...
          <div class="col-12 col-md-12">
            <div class="card">
                    ...
                    <tbody>
                      <?php  if (!empty($upcoming_follow_up_data)) { ?>
                        <?php  foreach ($upcoming_follow_up_data as $ufud) { ?>
                          <tr>
                            <td><a href="<?php  echo  MAINSITE_Admin . "Quotation-Module/quotation-view/" . $ufud->quotation_id ?>"
                                target="_blank"><?php  echo  $ufud->quotation_number ?></a></td>
                            ...
                            <td>
                              <button type="button" class="btn btn-info btn-sm" title="View"
                                onclick="view_quotation_followup_pop('<?php  echo  MAINSITE_Admin . "Quotation-Module/view-quotation-followup-pop" ?>' , <?php  echo  $ufud->quotation_id ?> , <?php  echo  $ufud->reff_quotation_id ?>)"><i
              ...
              <div class="card-footer clearfix">
                ...
                ?>
                <a target="_blank" href="<?php  echo  MAINSITE_Admin . $a_link ?>"
      ...
      <div class="col-md-8">
        <?php  if ($is_module_id_21 == 1) { ?>
          <div class="card">
                  ...
                  <tbody>
                    <?php  if (!empty($quotation_enquiry_data)) { ?>
                      ...
                      foreach ($quotation_enquiry_data as $urm) {
                        ...
                        <tr>
                          <td><a
                              href="<?php  echo  MAINSITE_Admin . $is_module_id_21_data->class_name . "/quotation-enquiry-view/" . $urm->quotation_enquiry_id ?>"><?php  echo  $urm->quotation_enquiry_number ?></a>
                          </td>
                          <td><?php  echo  $urm->customer_unique_name ?></td>
                          <td>
                            <?php  /*?><i class="fas fa-check"></i> <?php  */ ?>
                            <?php  echo  date("d-m-Y", strtotime($urm->inquiry_date)) ?>
                          </td>
                          <td>
                            <?php  /*?><i class="fas fa-times"></i> <?php  */ ?>
                            <?php  echo  date("d-m-Y h:i A", strtotime($urm->inquiry_closing_date)) ?>
                          </td>
            ...
            <div class="card-footer clearfix">
              <a target="_blank"
                href="<?php  echo  MAINSITE_Admin . $is_module_id_21_data->class_name . '/quotation-enquiry-edit' ?>"
                class="btn btn-sm btn-info float-left">Add New</a>
              <?php 
              $a_link = $is_module_id_21_data->class_name . '/' . $is_module_id_21_data->function_name;
              ?>
              <a target="_blank" href="<?php  echo  MAINSITE_Admin . $a_link ?>" class="btn btn-sm btn-secondary float-right">View
                All
              </a>
            </div>
            <!-- /.card-footer -->
                  ...
                  <tbody>
                    <?php  if (!empty($quotation_data)) { ?>
                      ...
                      foreach ($quotation_data as $urm) {
                        ...
                        <tr>
                          <td><a
                              href="<?php  echo  MAINSITE_Admin . $is_module_id_25_data->class_name . "/quotation-view/" . $urm->quotation_id ?>"><?php  echo  $urm->quotation_number ?></a>
                          </td>
                          <td><?php  echo  $urm->customer_unique_name ?></td>
                          <td><i class="fas fa-credit-card"></i> <?php  echo  $urm->total ?><br><i class="fas fa-sort-amount-up"></i>
                            <?php  echo  $urm->total_qty ?></td>
                  ...
                  <tbody>
                    <?php  if (!empty($proforma_invoice_data)) { ?>
                      ...
                      foreach ($proforma_invoice_data as $urm) {
                        ...
                        <tr>
                          <td><a
                              href="<?php  echo  MAINSITE_Admin . $is_module_id_26_data->class_name . "/proforma-invoice-view/" . $urm->proforma_invoice_id ?>"><?php  echo  $urm->proforma_invoice_number ?></a>
                          </td>
                          <td><?php  echo  $urm->customer_unique_name ?></td>
                          <td><i class="fas fa-credit-card"></i> <?php  echo  $urm->total ?><br><i class="fas fa-sort-amount-up"></i>
                            <?php  echo  $urm->total_qty ?></td>
                  ...
                  <tbody>
                    <?php  if (!empty($invoice_data)) { ?>
                      ...
                      foreach ($invoice_data as $urm) {
                        ...
                        <tr>
                          <td><a
                              href="<?php  echo  MAINSITE_Admin . $is_module_id_27_data->class_name . "/invoice-view/" . $urm->invoice_id ?>"><?php  echo  $urm->invoice_number ?></a>
                          </td>
                          <td><?php  echo  $urm->customer_unique_name ?></td>
                          <td><i class="fas fa-credit-card"></i> <?php  echo  $urm->total ?><br><i class="fas fa-sort-amount-up"></i>
                            <?php  echo  $urm->total_qty ?></td>
                  ...
                  <tbody>
                    <?php  if (!empty($invoice_delivery_note_data)) { ?>
                      ...
                      foreach ($invoice_delivery_note_data as $urm) {
                        ...
                        <tr>
                          <td><a
                              href="<?php  echo  MAINSITE_Admin . $is_module_id_39_data->class_name . "/invoice-delivery-note-view/" . $urm->invoice_delivery_note_id ?>"><?php  echo  $urm->invoice_delivery_note_number ?></a>
                          </td>
                          <td><?php  echo  $urm->customer_unique_name ?></td>
                          <td><i class="fas fa-credit-card"></i> <?php  echo  $urm->total ?><br><i class="fas fa-sort-amount-up"></i>
                            <?php  echo  $urm->total_qty ?></td>
                  ...
                  <tbody>
                    <?php  if (!empty($purchase_order_data)) { ?>
                      ...
                      foreach ($purchase_order_data as $urm) {
                        ...
                        <tr>
                          <td><a
                              href="<?php  echo  MAINSITE_Admin . $is_module_id_38_data->class_name . "/purchase-order-view/" . $urm->purchase_order_id ?>"><?php  echo  $urm->purchase_order_number ?></a>
                          </td>
