            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">
                        <?php  echo  $page_module_name ?> <small>Details</small>
                    </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="card ">
                    ...
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            ...
                            if ($user_access->update_module == 1) {
                                ?>
                                <a
                                    href="<?php  echo  MAINSITE_Admin . $user_access->class_name ?>/tour-edit/<?php  echo  $tour_data->tour_id ?>">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php  echo  $tour_data->available_slots ?>
                                        </td>
                                    ...
                                    <td>
                                            ...
                                            <?php  echo  $tour_data->minimum_age ?>
                                        </td>
                                        <td>
                                            <strong class="full">Tour Type</strong>
                                            <?php  echo  $tour_data->tour_type ?>
                                        </td>
                                        <td >
                                            <strong class="full">Location </strong>
                                            <div>
                                                <h6>
                                                    <?php  echo  $tour_data->location ?>
                                                </h6>
                                            </div>

                                            <div class="map-container">
                                                <iframe
                                                    src="https://maps.google.com/maps?q=<?php  echo  $tour_data->google_map_address ?>&output=embed"
                                        ...
                                        <td>
                                            ...
                                            <?php  if (!empty($tour_data->banner_image)) { ?>
                                                <span class="pip">
                                                    <a target="_blank"
                                                        href="<?php  echo  _uploaded_files_ . 'banner_image/' . $tour_data->banner_image ?>">
                                        ...
                                        <td>
                                            ...
                                            <?php  if (!empty($tour_data->cover_image)) { ?>
                                                <span class="pip">
                                                    <a target="_blank"
                                                        href="<?php  echo  _uploaded_files_ . 'cover_image/' . $tour_data->cover_image ?>">
                                                        <img class="imageThumb"
                                        ...
                                        <td colspan="5">
                                            ...
                                            <div>
                                                <?php  if (!empty($tour_data->important_notes)) { ?>
                                                    <?php  echo  $tour_data->important_notes ?>
                                                <?php  } else { ?>
                                                    <p>-</p>
                                                <?php  } ?>
                                            </div>
                                        ...
                                        <td colspan="5">
                                            ...
                                            <div>
                                                <?php  if (!empty($tour_data->additional_info)) { ?>
                                                    <?php  echo  $tour_data->additional_info ?>
                                                <?php  } else { ?>
                                                    <p>-</p>
                                                <?php  } ?>
                                            </div>
                                                ...
                                                <?php  if (!empty($tour_data->tour_date)) { ?>
                                                    <ol type="1" class="list-styled list-number">
                                                        <?php  foreach ($tour_data->tour_date as $item) { ?>
                                                            <li class="mb-1">
                                                                <?php  echo  $item->start_date_time ?> to <?php  echo  $item->end_date ?>&nbsp; &nbsp;
                                                                &nbsp; &nbsp; :
                                                                &nbsp; &nbsp; &nbsp; &nbsp;
                                                                <span class="text-bold p-1 ">  
                                                                <?php  if (empty($item->is_discount)): ?>
                              <span style="color: green;">
                                ₹<?php  echo  $item->actual_price ?></span>
                            <?php  else: ?>
                              <span class="inline-block">
                                <span class="text-muted ">
                                  <del>₹<?php  echo  $item->actual_price ?></del>
                                </span>
                                                                ...
                                                                <div class="card " style="width:100%;">
                                                                    <div class="card-header ">
                                                                        <a class="card-title w-100" data-toggle="collapse"
                                                                            ...
                                                                            <span>Day
                                                                                <?php  echo  $tour_data->tour_plan[$i]->day_number ?>
                                                                                :</span>
                                                                            <span class=" inline-block ">
                                                                                <?php  echo  $tour_data->tour_plan[$i]->day_name ?>
                                                                            </span>
                                                                        </a>
                                                                    </div>
                                                                    <div id="collapse<?php  echo  $i ?>" class="collapse "
                                                                        ...
                                                                        <div class="card-body">
                                                                            <?php  echo  $tour_data->tour_plan[$i]->day_plan ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="card card-primary" style="width:100%;">
                                                        ...
                                                        <div class=" d-flex justify-content-between p-2 " style="width:100%;">
                                                            ...
                                                            <h6 class="">Total Images:
                                                                ...
                                                                <?php  echo  count($tour_data->carousel_image) ?>
                                                            </h6>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="filter-container p-0 row">
                                                                <?php  foreach ($tour_data->carousel_image as $carousel_image): ?>
                                                                    ...
                                                                    <div class="filtr-item col-sm-3 mb-1"
                                                                        data-category="<?php  echo  "1 ,4" ?>" data-sort="white sample"
                                                                        style="width:100%;height:180px;">
                                                                        <a href="<?php  echo  _uploaded_files_ . 'carousel_image/' . $carousel_image->file ?>"
                                                                            data-toggle="lightbox" data-title=""
                                                                            style="height:100%;width:100%;">
                                                                            <img src="<?php  echo  _uploaded_files_ . 'carousel_image/' . $carousel_image->file ?>"
                                        ...
                                        <div class="card card-primary" style="width:100%;">
                                            ...
                                            <div class=" d-flex justify-content-between p-2 " style="width:100%;">
                                                ...
                                                <h6 class="">Total Images:
                                                    ...
                                                    <?php  echo  count($tour_data->gallery_image) ?>
                                                </h6>
                                            </div>
                                            <div class="card-body">
                                                <div class="filter-container p-0 row">
                                                    <?php  foreach ($tour_data->gallery_image as $gallery_image): ?>
                                                        ...
                                                        <div class="filtr-item col-sm-3 mb-1" data-category="<?php  echo  "1 ,4" ?>"
                                                            data-sort="white sample" style="width:100%;height:180px;">
                                                            <a href="<?php  echo  _uploaded_files_ . 'gallery_image/' . $gallery_image->file ?>"
                                                                data-toggle="lightbox" data-title=""
                                                                style="height:100%;width:100%;">
                                                                <img src="<?php  echo  _uploaded_files_ . 'gallery_image/' . $gallery_image->file ?>"
                                                                    class="img-fluid mb-2" alt="" aria-label=""
                                                                    style="height:100%;width:100%;object-fit:cover;" />
                                                            </a>
                    ...
                    <tr>
                        <td>
                            ...
                            <?php  echo  date("d-m-Y h:i:s A", strtotime($tour_data->added_on)) ?>
                        </td>
                        <td>
                            <strong class="full">Added By</strong>
                            <?php  echo  $tour_data->added_by_name ?>
                        </td>
                        <td>
                            <strong class="full">Updated On</strong>
                            <?php  if (!empty($tour_data->updated_on)) {
                        ...
                        <td>
                            ...
                            <?php  if (!empty($tour_data->updated_by_name)) {
                        ...
                        <td>
                            ...
                            <?php  if ($tour_data->status == 1) { ?> Active <i
