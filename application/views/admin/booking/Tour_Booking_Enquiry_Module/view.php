            ...
            <div class="col-12">
                ...
                <div class="card ">
                    ...
                    <div class="card-header">
                        <h3 class="card-title"><?=$tour_booking_enquiry_data->name?></h3>
                        <div class="float-right">
							...
							?>
							<a href="<?=MAINSITE_Admin.$user_access->class_name?>/edit/<?=$tour_booking_enquiry_data->tour_booking_enquiry_id?>"> 
                    ...
                    <div class="card-body card-primary card-outline">
                            ...
                            <div class="divTable" style="display:none;">
                            	...
                            	<div class="TableRow">
                                    ...
                                    <div class="table_col">
                                        ...
                                        <? if(!empty($tour_booking_enquiry_data->updated_on)){echo date("d-m-Y h:i:s A" , strtotime($tour_booking_enquiry_data->updated_on));}else{echo "-";}?>
                                    </div>
                                </div>                           
                            	<div class="TableRow">
                                	<div class="table_col">
                                        <label class="label_content_br">Updated By<span class="colen">:</span></label>
                                        <? if(!empty($tour_booking_enquiry_data->updated_by_name)){echo $tour_booking_enquiry_data->updated_by_name;}else{echo "-";}?>
                                    </div>
                                	<div class="table_col">
                                        <label class="label_content_br">Status<span class="colen">:</span></label>
                                        <? if($tour_booking_enquiry_data->status==1){ ?> Active <i class="fas fa-check btn-success btn-sm "></i>
                            ...
                            <table id="" class="table table-bordered table-hover myviewtable responsiveTableNewDesign"  >
								...
								<tr>
										...
										<?=$tour_booking_enquiry_data->tour_booking_enquiry_id?></td>
										<td >
...
<?=$tour_booking_enquiry_data->name?></td>
<td >
                                        <strong  class="full">Email</strong>
                                        <?=$tour_booking_enquiry_data->email?></td>
									...
									<tr>
                                        ...
                                        <td><strong class="full">Contact No</strong><?=$tour_booking_enquiry_data->contactno?></td>
                                        <td colspan="1"><strong class="full">Subject</strong><?=$tour_booking_enquiry_data->subject?></td>
                                        <td colspan="2">
                                        <strong class="full">Enquiry Descriptrion</strong>
                                         <?=$tour_booking_enquiry_data->description?></td>
                                    ...
                                    <td >
                                        ...
                                        <strong class="full">Tour Name</strong>
                                         <?=$tour_booking_enquiry_data->tour[0]->name?></td>
                                         <td colspan="1">
                                        <strong class="full">Tour Date</strong>
                                        <?php if (!empty($tour_booking_enquiry_data->tour_date)): ?>
                                            <?= $tour_booking_enquiry_data->tour_date[0]->start_date_time ?> TO <?= $tour_booking_enquiry_data->tour_date[0]->end_date ?></td>
                                            <?php else: ?>
                                                -
                                            <?php endif; ?>
                                        ...
                                        <?php if (!empty($tour_booking_enquiry_data->tour_date)): ?>
                                                        <?php if (empty($tour_booking_enquiry_data->tour_date[0]->is_discount)): ?>
                                                            ₹<?= $tour_booking_enquiry_data->tour_date[0]->actual_price ?>
                                                        <?php else: ?>

                                                            ₹<?= $tour_booking_enquiry_data->tour_date[0]->discounted_price ?>
                                    ...
                                    <td >
                                        ...
                                        <? if(!empty($tour_booking_enquiry_data->updated_by_name)){echo $tour_booking_enquiry_data->updated_by_name;}else{echo "-";}?></td>
                                    <td >
										<strong class="full">Updated On</strong>
										<? if(!empty($tour_booking_enquiry_data->updated_on)){echo date("d-m-Y h:i:s A" , strtotime($tour_booking_enquiry_data->updated_on));}else{echo "-";}?></td>
									<td >
