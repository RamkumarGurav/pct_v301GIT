										...
										<tbody>
											...
											foreach ($company_profile_data as $urm) {
												...
												<tr>
													...
													<? } ?>
													<td><a
															href="<?= MAINSITE_Admin . $user_access->class_name . "/company-profile-view/" . $urm->company_profile_id ?>"><?= $urm->company_unique_name ?></a>
													</td>
													<td><?= $urm->company_name ?></td>
													<td><?= $urm->name ?><br><?= $urm->email ?><br> <?= $urm->mobile_no ?></td>
