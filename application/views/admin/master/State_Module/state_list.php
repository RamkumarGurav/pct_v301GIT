                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="field_name" id="field_name" class="form-control"
                                                    ...
                                                    <option value='urm.state_name' <?php if ($field_name == 'urm.state_name') {
                                                        echo 'selected';
                                                    } ?>>State
                                                    </option>
                                                    <option value='urm.state_code' <?php if ($field_name == 'urm.state_code') {
                                                        echo 'selected';
                                                    } ?>>State
                                                        Code</option>
                                                </select>
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            ...
                            if ($user_access->add_module == 1) {
                                ?>
                                <a href="<?php echo MAINSITE_Admin . $user_access->class_name ?>/state-edit">
                    ...
                    if ($user_access->view_module == 1) {
                        ...
                        <div class="card-body">
                            ...
                            <?php echo form_open(MAINSITE_Admin . "$user_access->class_name/userState-doUpdateStatus", array('method' => 'post', 'id' => 'ptype_list_form', "name" => "ptype_list_form", 'style' => '', 'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data')); ?>
                                            ...
                                            <tr>
                                                ...
                                                <?php if ($user_access->update_module == 1) { ?>
                                                    <td><input type="checkbox" name="sel_recds[]" id="sel_recds<?php echo $count; ?>"
                                                            value="<?php echo $urm->state_id; ?>" /></td>
                                                <?php } ?>
                                                <td><a
                                                        href="<?php echo MAINSITE_Admin . $user_access->class_name . "/state-view/" . $urm->state_id ?>"><?php echo $urm->state_name ?></a>
                                                </td>
                                                <td><?php echo $urm->country_name ?></td>
                                                <td><?php echo $urm->state_code ?></td>
                                                <td>
