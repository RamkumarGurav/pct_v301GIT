...
if (!empty($unit_of_measurement_master_data)) {
    ...
    // $unit_of_measurement_id = $unit_of_measurement_master_data->unit_of_measurement_id;
    // $unit_of_measurement_name = $unit_of_measurement_master_data->unit_of_measurement_name;
    // $status = $unit_of_measurement_master_data->status;
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title"><?php echo $unit_of_measurement_master_data->unit_of_measurement_name ?>
                        </h3>
                        <div class="float-right">
                            ...
                            if ($user_access->update_module == 1) {
                                ?>
                                <a
                                    href="<?php echo MAINSITE_Admin . $user_access->class_name ?>/unit-of-measurement-edit/<?php echo $unit_of_measurement_master_data->unit_of_measurement_id ?>">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <?php echo $unit_of_measurement_master_data->unit_of_measurement_id ?>
                                        </td>
                                        <td>
                                            <strong class="full">Unit Of Measurement</strong>
                                            <?php echo $unit_of_measurement_master_data->unit_of_measurement_name ?>
                                        </td>
                                        <td>
                                            <strong class="full">Added On</strong>
                                            <?php echo date("d-m-Y h:i:s A", strtotime($unit_of_measurement_master_data->added_on)) ?>
                                        </td>
                                        <td>
                                            <strong class="full">Added By</strong>
                                            <?php echo $unit_of_measurement_master_data->added_by_name ?>
                                        </td>
                                        <td>
                                            <strong class="full">Updated On</strong>
                                            <?php if (!empty($unit_of_measurement_master_data->updated_on)) {
                                                echo date("d-m-Y h:i:s A", strtotime($unit_of_measurement_master_data->updated_on));
                                            } else {
                                                echo "-";
                                            } ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php if (!empty($unit_of_measurement_master_data->updated_by_name)) {
                                                echo $unit_of_measurement_master_data->updated_by_name;
                                            } else {
                                                echo "-";
                                            } ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php if ($unit_of_measurement_master_data->status == 1) { ?> Active <i
