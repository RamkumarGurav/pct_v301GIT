...
$filename = "Unit-Of-Measurement-List-" . date('d-m-Y') . ".xls";
    ...
    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
        <thead>
            ...
            <tr>
                ...
                <th style="background-color:#999" width="*">Unit Of Measurement</th>
        ...
        <tbody>
            ...
            if (!empty($unit_of_measurement_master_data)) { //print_r($ptype_list);
                foreach ($unit_of_measurement_master_data as $row) {
                    //if($row->in_hand > 0 || $row->total_purchase > 0 || $row->total_sold > 0 || $row->total_returned > 0 || $row->to_receive > 0 )
                    {
                        ...
                        <tr>
                            ...
                            <td width="*"><?php echo $row->unit_of_measurement_name; ?></td>
