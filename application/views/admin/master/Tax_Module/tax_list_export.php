...
$filename = "Tax-List-" . date('d-m-Y') . ".xls";
    ...
    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
        <thead>
            ...
            <tr>
                ...
                <th style="background-color:#999" width="*">Tax Name</th>
                <th style="background-color:#999" width="*">Tax Percentage</th>
        ...
        <tbody>
            ...
            if (!empty($tax_data)) { //print_r($ptype_list);
                foreach ($tax_data as $row) {
                    //if($row->in_hand > 0 || $row->total_purchase > 0 || $row->total_sold > 0 || $row->total_returned > 0 || $row->to_receive > 0 )
                    {
                        ...
                        <tr>
                            ...
                            <td width="*"><?php echo $row->tax_name; ?></td>
                            <td width="*"><?php echo $row->tax_percentage; ?></td>
