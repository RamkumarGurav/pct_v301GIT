				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<?php if (!empty($tax_data)) { ?>
							<li class="breadcrumb-item"><a
									href="<?php echo MAINSITE_Admin . $user_access->class_name . "/tax_view/" . $tax_id ?>">View</a></li>
						<?php } ?>
			...
			<div class="col-12">
				...
				<div class="card">
					...
					<div class="card-header">
						<h3 class="card-title"><?php echo $tax_name ?> <small><?php echo $record_action ?></small></h3>
					</div>
					<!-- /.card-header -->
					<?php
					if ($user_access->view_module == 1 || true) {
						...
						<div class="card-body">
							...
							<?php echo form_open(MAINSITE_Admin . "$user_access->class_name/userTaxDoEdit", array('method' => 'post', 'id' => 'ptype_list_form', "name" => "ptype_list_form", 'style' => '', 'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data')); ?>
							<input type="hidden" name="tax_id" id="tax_id" value="<?php echo $tax_id ?>" />
							<input type="hidden" name="redirect_type" id="redirect_type" value="" />

							<div class="row">
								<div class="col-lg-3 col-md-4 col-sm-6">
									<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Tax <span
											style="color:#f00;font-size: 22px;margin-top: 3px;">*</span></label>
									<div class="col-sm-10">
										<input type="text" class="form-control form-control-sm" required id="tax_name" name="tax_name"
											value="<?php echo $tax_name ?>" placeholder="Tax">

									</div>
								</div>
								<div class="col-lg-3 col-md-4 col-sm-6">
									<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Tax Percentage <span
											style="color:#f00;font-size: 22px;margin-top: 3px;">*</span></label>
									<div class="col-sm-10">
										<input type="number" class="form-control form-control-sm" required id="tax_percentage"
											name="tax_percentage" value="<?php echo $tax_percentage ?>" placeholder="Tax Percentage">
