                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="field_name" id="field_name" class="form-control"
                                                    ...
                                                    <option value='urm.terms_and_conditions_name' <?php if ($field_name == 'urm.terms_and_conditions_name') {
                                                        echo 'selected';
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            ...
                            if ($user_access->add_module == 1) {
                                ?>
                                <a
                                    href="<?php echo MAINSITE_Admin . $user_access->class_name ?>/terms-and-conditions-edit">
                    ...
                    if ($user_access->view_module == 1) {
                        ...
                        <div class="card-body">
                            ...
                            <?php echo form_open(MAINSITE_Admin . "$user_access->class_name/userTermsandConditions-doUpdateStatus", array('method' => 'post', 'id' => 'ptype_list_form', "name" => "ptype_list_form", 'style' => '', 'class' => 'form-horizontal', 'role' => 'form')); ?>
                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                <?php if (!empty($terms_and_conditions_master_data)) { ?>
                                    <tbody>
                                        <?php
                                        ...
                                        foreach ($terms_and_conditions_master_data as $urm) {
                                            $count++;
                                            ?>
                                            <tr>
                                                ...
                                                <?php if ($user_access->update_module == 1) { ?>
                                                    <td><input type="checkbox" name="sel_recds[]" id="sel_recds<?php echo $count; ?>"
                                                            value="<?php echo $urm->terms_and_conditions_id; ?>" /></td>
                                                <?php } ?>
                                                <td><a
                                                        href="<?php echo MAINSITE_Admin . $user_access->class_name . "/terms-and-conditions-view/" . $urm->terms_and_conditions_id ?>"><?php echo $urm->terms_and_conditions_name ?></a>
                                                </td>
