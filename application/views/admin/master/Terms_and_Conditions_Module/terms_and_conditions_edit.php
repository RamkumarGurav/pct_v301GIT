				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<?php if (!empty($terms_and_conditions_master_data)) { ?>
							<li class="breadcrumb-item"><a
									href="<?php echo MAINSITE_Admin . $user_access->class_name . "/terms_and_conditions_view/" . $terms_and_conditions_id ?>">View</a>
							</li>
						<?php } ?>
			...
			<div class="col-12">
				...
				<div class="card">
					...
					<div class="card-header">
						<h3 class="card-title"><?php echo $terms_and_conditions_name ?> <small><?php echo $record_action ?></small>
						</h3>
					</div>
					<!-- /.card-header -->
					<?php
					if ($user_access->view_module == 1 || true) {
						...
						<div class="card-body">
							...
							<input type="hidden" name="terms_and_conditions_id" id="terms_and_conditions_id"
								value="<?php echo $terms_and_conditions_id ?>" />
							...
							<div class="row">
								<div class="form-group col-md-6 row">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control form-control-sm" required id="terms_and_conditions_name"
											name="terms_and_conditions_name" value="<?php echo $terms_and_conditions_name ?>"
