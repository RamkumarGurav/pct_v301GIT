...
$filename = "Terms-and-Conditions-List-" . date('d-m-Y') . ".xls";
    ...
    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
        <thead>
            ...
            <tr>
                ...
                <th style="background-color:#999" width="*">Terms and Conditions</th>
        ...
        <tbody>
            ...
            if (!empty($terms_and_conditions_master_data)) { //print_r($ptype_list);
                foreach ($terms_and_conditions_master_data as $row) {
                    //if($row->in_hand > 0 || $row->total_purchase > 0 || $row->total_sold > 0 || $row->total_returned > 0 || $row->to_receive > 0 )
                    {
                        ...
                        <tr>
                            ...
                            <td width="*"><?php   echo $row->terms_and_conditions_name; ?></td>
