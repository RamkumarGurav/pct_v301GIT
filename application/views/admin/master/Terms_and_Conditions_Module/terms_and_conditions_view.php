            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title"><?php   echo $terms_and_conditions_master_data->terms_and_conditions_name ?>
                        </h3>
                        <div class="float-right">
                            <?php  
                            if ($user_access->add_module == 1 && false) {
                                ?>
                                <a href="<?php   echo MAINSITE_Admin . $user_access->class_name ?>/terms-and-conditions-edit">
                            ...
                            if ($user_access->update_module == 1) {
                                ?>
                                <a
                                    href="<?php   echo MAINSITE_Admin . $user_access->class_name ?>/terms-and-conditions-edit/<?php   echo $terms_and_conditions_master_data->terms_and_conditions_id ?>">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <?php   echo $terms_and_conditions_master_data->terms_and_conditions_id ?>
                                        </td>
                                        <td>
                                            <strong class="full">Terms and Conditions</strong>
                                            <?php   echo $terms_and_conditions_master_data->terms_and_conditions_name ?>
                                        </td>
                                        <td>
                                            <strong class="full">Added On</strong>
                                            <?php   echo date("d-m-Y h:i:s A", strtotime($terms_and_conditions_master_data->added_on)) ?>
                                        </td>
                                        <td>
                                            <strong class="full">Added By</strong>
                                            <?php   echo $terms_and_conditions_master_data->added_by_name ?>
                                        </td>
                                        <td>
                                            <strong class="full">Updated On</strong>
                                            <?php   if (!empty($terms_and_conditions_master_data->updated_on)) {
                                                echo date("d-m-Y h:i:s A", strtotime($terms_and_conditions_master_data->updated_on));
                                            } else {
                                                echo "-";
                                            } ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php   if (!empty($terms_and_conditions_master_data->updated_by_name)) {
                                                echo $terms_and_conditions_master_data->updated_by_name;
                                            } else {
                                                echo "-";
                                            } ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php   if ($terms_and_conditions_master_data->status == 1) { ?> Active <i
