...
class Gallery_Module extends Main
{
  ...
  function index()
  {
    ...
    parent::get_header();
    parent::get_left_nav();
    $this->load->view('admin/media/Gallery_Module/listings', $this->data);
    parent::get_footer();
  }
  ...
  function view($gallery_id = "")
  {
    ...
    parent::get_header();
    parent::get_left_nav();
    $this->load->view('admin/media/Gallery_Module/view', $this->data);
    parent::get_footer();
  }
  ...
  function edit($gallery_id = "")
  {
    ...
    if (!empty($gallery_id)) {
      ...
      $this->data['gallery_data'] = $this->data['gallery_data'][0];
      $tour_id = $this->data['gallery_data']->tour_id;
    ...
    parent::get_header();
    parent::get_left_nav();
    $this->load->view('admin/media/Gallery_Module/edit', $this->data);
    parent::get_footer();
  }
  ...
  function doEdit()
  {
    ...
    if (!empty($gallery_id)) {
      ...
      $insertStatus = $this->Common_Model->update_operation(array('table' => 'tour_booking_enquiry', 'data' => $enter_data, 'condition' => "gallery_id = $gallery_id"));
      ...
      $gallery_id = $insertStatus = $this->Common_Model->add_operation(array('table' => 'tour_booking_enquiry', 'data' => $enter_data));
      if (!empty($insertStatus)) {
  ...
  function doUpdateStatus()
  {
    ...
    if ($user_access->update_module == 1) {
      ...
      if (!empty($id_arr)) {
        ...
        $response = $this->Common_Model->update_operation(array('table' => "tour_booking_enquiry", 'data' => $update_data, 'condition' => "gallery_id in ($ids)"));
        if ($response) {
  ...
  function ajax_insert_tourget_gallery()
  {
  ...
  function export()
  {
    ...
    $this->load->view('admin/media/Gallery_Module/export', $this->data);
  }
  ...
  function pdf()
  {
    ...
    $html = $this->load->view('admin/media/Gallery_Module/pdf', $this->data, true);
    //echo $html;
